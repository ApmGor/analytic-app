...
@SpringBootTest
@EmbeddedKafka(
        topics = { AbstractKafkaTest.KAFKA_TOPIC },
        partitions = 3,
        bootstrapServersProperty = "spring.kafka.bootstrap-servers"
)
public abstract class AbstractKafkaTest {

    protected static final String KAFKA_TOPIC = "products-analytic";
    ...
    protected <K, V> KafkaReceiver<K, V> createReceiver(final UnaryOperator<ReceiverOptions<K, V>> builder) {
    ...
    protected <K, V> KafkaSender<K, V> createSender(final UnaryOperator<SenderOptions<K, V>> builder) {
    ...
    protected <K, V> SenderRecord<K, V, K> toSenderRecord(final String topic, final K key, final V value) {
